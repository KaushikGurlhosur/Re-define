  ...
  return (
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <BentoTilt className="border-hsla relative mb-4 md:mb-7 h-96 w-full overflow-hidden rounded-md md:h-h-[65vh]">
          <BentoCard
        ...
        <div className="grid h-screen md:grid-flow-col md:grid-row-3 gap-4 md:gap-7 mb-3 md:mb-7 ">
          <BentoTilt className="bento-tilt_1 row-span-4">
            <BentoCard
          ...
          <BentoTilt className="bento-tilt_1 col-span-2 row-span-2">
            <BentoCard
