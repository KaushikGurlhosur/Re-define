...
const Hero = () => {
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      {isLoading && (
        <div className="flex-center z-100 absolute h-dvh w-screen overflow-hidden bg-violet-50">
        ...
        <div className="z-40 absolute left-0 top-0 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <Button
              ...
              containerClass="bg-yellow-300/80 hover:bg-yellow-300 transition-all duration-300 ease-in flex-center gap-1 "
            />
          </div>
        </div>
      </div>
